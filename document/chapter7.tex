...
We also see that the magnitude of the defect order grows with increasing $|K|$ [polar order, Figure~\ref{f:7-Orient_PolarHex}(C,F) and three-fold bond angle order, Figure~\ref{f:7-Orient_PolarHex}(J,M)]; this makes intuitive sense as the defects \fxnote{blah blah, need proper cvolors}.
\begin{figure}
  \centering
...
We are currently working on implementing the algorithm in Ref.~\fxnote{Sabetta's discrete geo}.
