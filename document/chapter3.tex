...
\end{figure}\fxnote{Clarify panel D}
...
\end{figure}\fxnote{zoom in for panel C, change integrand to over phi' in D,E}
...
\end{figure}\fxnote{italicize cost}
\newpage
...
\end{figure}\fxnote{bracket the subscripts}
...
\end{figure}\fxnote{change the font on cost}
...
This means that $\displaystyle{\sqrt{\Delta N_{\Theta}^2}} \bigg / \displaystyle {\overbar{N}_{\Theta}} \sim \overbar{N}_{\Theta}^{-1/2}$, the expected result for an equilibrium system subject to number fluctuations~\fxnote{ref Pathria}, again suggesting that activity can play a role akin to temperature in equilibrium systems.
\begin{figure}
  \centering
...
\end{figure}\fxnote{vertical line in panel A}
