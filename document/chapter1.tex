...
We can characterize a surface with its Euler characteristic, which we calculate using the Gauss-Bonnet theorem; here writing the theorem for a closed surface~\cite{RN23}:
\begin{equation}
