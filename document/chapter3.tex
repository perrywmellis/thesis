...
To see the rammificaitons of the activity, we evaluate $\nabla \cdot \bm{\sigma}^{active}$,
\begin{align}
...
\end{align}
The second term in Eq.~\ref{e:3-ActiveInstabilityD} relates the force denisty due to the activity to splay and bend distortions in the nematic.
...
For example, consider the director structure of a $s = +1/2$ defect shown by the white lines in Figure~\ref{f:3-DefectFlow}(A); an extensile stress along the director will cause the bend distortion to grow and the splay distortion to decrease, causing defect to propagate along the red arrow.
