...
The variations in $\rho$ and $\beta$ are a result of different scales between px and $\upmu$m depending on the microscope used, the microscope zoom, and the output image size.
...
he $s=+1/2$ and $s=-1/2$ defects are indicated in Fig. ED1f by ${\color{red} \blacktriangle } $  and  ${ \color{blue} \blacktriangledown } $, respectively.
