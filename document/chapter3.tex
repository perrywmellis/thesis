...
Both of the confocals we use excite the sample by scanning laser over the image plane, adjusting the height of the stage, and then repeating the process to form an image stack.
