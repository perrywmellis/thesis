...
For example, the reported measurements of $K_{24}$ for 5CB, the most common thermotropic NLC in the literature, vary from BLAH to BLAH [see Table BLAH]\fxnote{make a trable}.
Even after correcting for notational differences and representing the saddle splay distortion as in Eq.~\ref{e:2-FrankFinalExpansion}, we see in Table BLAH\fxnote{make a trable} that the published measurements are in general imprecise.
