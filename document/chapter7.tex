...
Prior work with spherical emulsion droplets of 5CB in water and PVA found a size dependent transition, with bipolar configurations observed for droplets with radius $R \grtsim 1$ $\upmu$m and radial configurations for $R \lesssim 1$ $\upmu$`\cite{miller2013influence}.
 \fxnote{HERE}
