...
The cyanobiphynyls are thermotropic materials characterized by a cyano $\textrm{(CN)}$ group bonded to a biphenyl $\textrm{(C_6 H_4)(C_6 H_4)}$ group bonded to an alkyl group of given length, $\textrm{C_p H_{2p+1}}$, where ``p'' is the number of Carbon atoms in the group.
In the case of 5CB, we can write the chemical formula as: $\textrm{CN(C_6 H_4)(C_6 H_4)C_5 H_{11}}$.
