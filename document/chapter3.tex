...
In addition, this result is consistent with the fact that when the ATP runs out in an experiment and the activity ceases, the nematic configuration becomes static and does not relax to the ground state; the elasticity in the experiments is too weak when $\alpha = 0$.
This also indicates that thermal fluctuations are not strong enough to cause the defects to move in the absence of activity.
