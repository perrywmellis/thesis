...
Prior work with spherical emulsion droplets of 5CB in water and PVA found a size dependent transition, with bipolar configurations observed for droplets with radius $R \gtrsim 1$ $\upmu$m and radial configurations for $R \lesssim 1$ $\upmu$m~\cite{miller2013influence}.\fxnote{HERE}
