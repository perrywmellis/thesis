...
Therefore, Gauss's law can always be applied such that any nontrivial saddle-splay distortion in $V$ must affect $\mathbf{n}$ on $\partial V$.
...
Due to this connection between the bulk saddle-splay distortion and the director orientation on a bounding manifold, the saddle-splay distortion term is often referred to as a surface-like term and sometimes even referred to as an effective anchoring term.
