...
Polarized fluorescence has proven to be an incredibly effective tool in diagnostic imaging and the medical community, from techniques like F\"oster Resonance Energy Transfer (FRET, \cite{fret}), used to measure cellular or molecular mobility, to the myriad of assays designed to measure quantities such as enzyme content~\cite{RN282,RN284}.
...
\begin{figure}
  ...
  The maximum at $\Phi_A = 45^o$ and minima at $\Phi_A = 0^o,\, 90^o$ implies that the optic axis of the mirror is along either $\hat{x}$ or $\hat{y}$.}\label{f:5-DichroicMirror}
\end{figure}
...
\begin{figure}
  ...
  The rubbing direction is along $90^o$.
  The range  in $I$ is 6\% of the mean.}
